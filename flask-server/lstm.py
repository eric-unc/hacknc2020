...
def get_notes():
    ...
    for file in glob.glob("{}/*.mid".format(upload_dir)): #loop through all the files
        ...
        try: # file has instrument parts
            s2 = instrument.partitionByInstrument(midi) #separate based on instrument
            notes_to_parse = s2.parts[0].recurse()  #get first instrument (assuming no other instruments)
